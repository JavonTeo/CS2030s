  ...
  public static String getGrade(String student, String module, String assessment,
    ...
    Transformer<Map<String, Map<String, String>>, 
        Maybe<Map<String, String>>> getModule = new Transformer<>() {
          public Maybe<Map<String, String>> transform(Map<String, Map<String, String>> map) {
            return Maybe.of(Maybe.of(map.get(module))).orElse(Maybe.of(null));
          }
        };

    Transformer<Map<String, String>, Maybe<String>> getAssessment = new Transformer<>() {
      public Maybe<String> transform(Map<String, String> map) {
        return Maybe.of(Maybe.of(map.get(assessment))).orElse(Maybe.of(null));
      }
    };
